...
complication01.pie<-ggplot(out, aes(x="", fill=ClavienDindoComplication01))+
  geom_bar(width = 1)+
...
complication.type.pie<-ggplot(df, aes(x="", y=Prop, fill=Complication.Type))+ geom_bar(stat="identity", width=1)+geom_text(aes(label=paste0(round(Prop*100), "%"),x=1.2), color="white",position = position_stack(vjust = 0.5))+coord_polar("y", start=0)
